...
You can then execute your native executable with: `./target/athena-s3-1.0.0-runner`

If you want to learn more about building native executables, please consult <https://quarkus.io/guides/maven-tooling>.

## Related Guides

- Camel AWS 2 Athena ([guide](https://camel.apache.org/camel-quarkus/latest/reference/extensions/aws2-athena.html)): Access AWS Athena service using AWS SDK version 2.x
